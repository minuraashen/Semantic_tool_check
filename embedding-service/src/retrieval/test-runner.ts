...
const groundTruthPath = path.resolve(rootDir, '../ground-truth.json');
const dbPath = path.resolve(rootDir, 'data/embeddings.db');
const csvOutputPath = path.resolve(rootDir, '../results-automated.csv');
const jsonOutputPath = path.resolve(rootDir, '../results-automated.json');
